export const races = [
    {
      ...
      descricao: `Nos confins da maioria dos mundos, os humanos são a
...
dos mundos. `,
  ...
  O que começa como uma busca por vingança de um único anão, pode se tornar a ambição de todo um clã. `,
    ...
    },
    {
      ...
      nome: "Halfling",
      image: require("../assets/images/racesImages/elfo.jpg"),
      descricao: `Os confortos de um lar são os objetivos da maioria dos
...
balsa flutuando rio abaixo. `,
    ...
    },
    {
      ...
      nome: "Draconato",
      image: require("../assets/images/racesImages/elfo.jpg"),
      descricao: `Descendentes de dragões, como seus nomes
...
os que encontram-se à toa, sem um objetivo claro na vida. `,
    ...
    },
    {
      ...
      nome: "Gnomo",
      image: require("../assets/images/racesImages/elfo.jpg"),
      descricao: `Um zumbido constante de atividades permeia a
...
investigação, criação e brincadeira. `,
    ...
    },
    {
      ...
      nome: "Meio-Elfo",
      image: require("../assets/images/racesImages/elfo.jpg"),
      descricao: `Vagando entre dois mundos mas, na verdade, não
...
desafortunados e adentrando uma vida de aventura. `,
    ...
    },
    {
      ...
      nome: "Meio-Orc",
      image: require("../assets/images/racesImages/elfo.jpg"),
      descricao: `Quer estejam unidos sob a liderança de um poderoso
...
notoriedade por seus costumes bárbaros e fúria selvagem. `,
    ...
    },
    {
      ...
      nome: "Tiefling",
      image: require("../assets/images/racesImages/elfo.jpg"),
      descricao: `Ser recebido com olhares e cochichos, sofrer violência e
